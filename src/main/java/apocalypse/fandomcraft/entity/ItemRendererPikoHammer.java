 ...
 public class ItemRendererPikoHammer
   ...
   public void renderItem(IItemRenderer.ItemRenderType type, ItemStack item, Object... data) {
     switch (type) {
       ...
       case EQUIPPED:
         ...
         (Minecraft.getMinecraft()).renderEngine.bindTexture(new ResourceLocation("fandomcraft:textures/models/entity/pikoHammer.png"));
