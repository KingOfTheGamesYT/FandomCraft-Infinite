 ...
 public class EntityTingle extends EntityMob {
   protected void fall(float p_70069_1_) {}

   public EntityTingle(World world) {
     super(world);
     setSize(0.8F, 1.0F);
     ...
     this.tasks.addTask(5, (EntityAIBase)new EntityAIPanic((EntityCreature)this, 5.0D));
   ...
   protected void dropRareDrop(int p_70600_1_) {
     switch (this.rand.nextInt(3)) {
       ...
       case 0:
         dropItem(Main.bomb, 5);
         break;
       case 1:
         dropItem(Main.redLion, 1);
         break;
     }
   }
   ...
   public boolean attackEntityAsMob(Entity p_70652_1_) {
     ...
     playSound("fandomcraft:tingleDie", 1.0F, 1.0F / (getRNG().nextFloat() * 0.4F + 0.8F));
     return flag;
   }
