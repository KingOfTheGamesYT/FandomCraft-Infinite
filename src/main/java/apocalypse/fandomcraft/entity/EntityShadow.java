   ...
   extends EntityMob
 {
   ...
   public EntityShadow(World world) {
     ...
     this.tasks.addTask(2, (EntityAIBase)(this.aiTempt = new EntityAITempt((EntityCreature)this, 0.6D, Main.keyKingdom, true)));
     ...
     this.tasks.addTask(5, (EntityAIBase)new EntityAILeapAtTarget((EntityLiving)this, 5.0F));
   ...
   public boolean attackEntityAsMob(Entity p_70652_1_) {
     ...
     playSound("mob.spider.death", 1.0F, 1.0F);
     return flag;
   }
