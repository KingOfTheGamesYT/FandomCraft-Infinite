   ...
   extends EntityMob
 {
   ...
   public EntityGoomba(World world) {
     ...
     this.tasks.addTask(2, (EntityAIBase)(this.aiTempt = new EntityAITempt((EntityCreature)this, 0.6D, Main.starHammer, true)));
   ...
   protected String getDeathSound() {
     return "fandomcraft:goombaStomp";
   }
