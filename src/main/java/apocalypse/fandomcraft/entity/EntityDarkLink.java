 ...
 public class EntityDarkLink
   ...
   public EntityDarkLink(World world) {
     super(world);
     setSize(1.0F, 2.0F);
   ...
   public boolean attackEntityAsMob(Entity p_70652_1_) {
     ...
     if (a == 1) {
       ...
       playSound("fandomcraft:linkAngryAttack", 1.0F, 1.0F / (getRNG().nextFloat() * 0.4F + 0.8F));
       return bool;
     }
