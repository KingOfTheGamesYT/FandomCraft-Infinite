 ...
 public class EntityBeastGannon
   extends EntityMob implements IBossDisplayData, IGanon {
   private int attackTimer;
   private EntityAITempt aiTempt;

   protected void fall(float p_70069_1_) {}

   public EntityBeastGannon(World world) {
     super(world);
     setSize(1.8F, 2.4F);
     ...
     this.tasks.addTask(2, (EntityAIBase)new EntityAIWatchClosest((EntityLiving)this, EntityPlayer.class, 16.0F));
   ...
   public boolean attackEntityAsMob(Entity p_70652_1_) {
     ...
     if (a == 1) {
       ...
       boolean bool = p_70652_1_.attackEntityFrom(DamageSource.causeMobDamage((EntityLivingBase)this), (10 + this.rand.nextInt(15)));
       ...
       playSound("fandomcraft:bossSay", 1.0F, 1.0F / (getRNG().nextFloat() * 0.4F + 0.8F));
       return bool;
     }

     this.attackTimer = 10;
     this.worldObj.setEntityState((Entity)this, (byte)4);
     boolean flag = p_70652_1_.attackEntityFrom(DamageSource.causeMobDamage((EntityLivingBase)this), (15 + this.rand.nextInt(20)));
     ...
     playSound("fandomcraft:fierceGrowl", 1.0F, 1.0F / (getRNG().nextFloat() * 0.4F + 0.8F));
     return flag;
   }
   ...
   private static final ItemStack defaultHeldItem = new ItemStack(Main.masterSword);
