   ...
   extends EntityMob
 {
   ...
   public EntityAttackPig(World p_i1739_1_) {
     super(p_i1739_1_);
   ...
   public void onUpdate() {
     ...
     {
       playSound("mob.pig.death", getSoundVolume() * 2.0F, ((this.rand.nextFloat() - this.rand.nextFloat()) * 0.2F + 1.0F) * 1.8F);
     }
   ...
   public boolean attackEntityFrom(DamageSource p_70097_1_, float p_70097_2_) {
     ...
     if (entity instanceof EntityPlayer) {
       ...
       for (int i = 0; i < list.size(); i++) {
         ...
         if (entity1 instanceof EntityAttackPig) {

           EntityAttackPig entitypigzombie = (EntityAttackPig)entity1;
