 ...
 public class EntityArmos
   extends EntityMob {
   private int slimeJumpDelay;

   public EntityArmos(World p_i1742_1_) {
     super(p_i1742_1_);
     setSize(1.0F, 1.0F);
   ...
   protected String getStepSound() {
     return "fandomcraft:armosStep";
   }

   protected String getHurtSound() {
     return "fandomcraft:armosSay";
   }
   ...
   public boolean attackEntityAsMob(Entity p_70652_1_) {
     ...
     playSound("fandomcraft:armosSay", 1.0F, 1.0F);
     return flag;
   }
