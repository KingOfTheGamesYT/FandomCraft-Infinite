   ...
   extends EntityThrowable
 {
   ...
   public EntityPellet(World par1World) {
     super(par1World);
   }

   public EntityPellet(World world, EntityLivingBase living, float f) {
     super(world, living);
     this.power = f;
   }

   public EntityPellet(World world, double x, double y, double z) {
     super(world, x, y, z);
   }
