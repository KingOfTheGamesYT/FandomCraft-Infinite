   ...
   extends EntityThrowable
 {
   ...
   public EntityShadowBall(World par1World) {
     ...
     this.fadeTimer = 0; } public EntityShadowBall(World world, EntityLivingBase living, float f) { super(world, living); this.fadeTimer = 0; this.power = f; } public EntityShadowBall(World world, double x, double y, double z) { super(world, x, y, z); this.fadeTimer = 0; }
