 ...
 public class EntityFireKeese
   extends EntityMob
 {
   private ChunkCoordinates spawnPosition;

   public EntityFireKeese(World p_i1680_1_) {
     super(p_i1680_1_);
     setSize(1.0F, 1.5F);
   ...
   public boolean attackEntityAsMob(Entity p_70652_1_) {
     if (super.attackEntityAsMob(p_70652_1_)) {
       if (p_70652_1_ instanceof EntityLivingBase) {
         byte b0 = 15;
         ((EntityLivingBase)p_70652_1_).addPotionEffect(new PotionEffect(Potion.weakness.id, b0 * 20, 0));
         ((EntityLivingBase)p_70652_1_).setFire(5);
       }
       return true;
     }
     return false;
