 ...
 public class EntityCharmander extends EntityMob {
   ...
   protected String getLivingSound() {
     return "fandomcraft:charmanderSay";
   }

   protected String getHurtSound() {
     return "fandomcraft:charmanderHit";
   }

   protected String getDeathSound() {
     return "fandomcraft:charmanderDie";
   }
   ...
   public boolean attackEntityAsMob(Entity p_70652_1_) {
     ...
     if (a == 1) {
       ...
       playSound("fandomcraft:charmanderAngry", 1.0F, 1.0F / (getRNG().nextFloat() * 0.4F + 0.8F));
       return bool;
     }
     ...
     ((EntityLivingBase)p_70652_1_).setFire(15);
