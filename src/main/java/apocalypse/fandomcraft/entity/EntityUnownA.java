   ...
   extends EntityMob
 {
   ...
   public EntityUnownA(World p_i1731_1_) {
     super(p_i1731_1_);
   ...
   public void onLivingUpdate() {
     ...
     {
       this.worldObj.playSoundEffect(this.posX + 0.5D, this.posY + 0.5D, this.posZ + 0.5D, "fandomcraft:DarknessShot", 0.1F + this.rand.nextFloat(), this.rand.nextFloat() * 0.7F + 0.3F);
     }
