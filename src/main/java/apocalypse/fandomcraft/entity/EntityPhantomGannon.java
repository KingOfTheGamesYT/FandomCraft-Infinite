 ...
 public class EntityPhantomGannon extends EntityMob implements IBossDisplayData, IGanon {
   private int attackTimer;
   private EntityAITempt aiTempt;

   protected void fall(float p_70069_1_) {}

   public EntityPhantomGannon(World world) {
     super(world);
     setSize(1.0F, 2.0F);
   ...
   protected Item getDropItem() {
     return Main.gannonSword;
   }

   protected void dropFewItems(int p_70628_2_) {
     entityDropItem(new ItemStack(Main.song5, 1), 0.0F);
     entityDropItem(new ItemStack(Main.heart, 2), 0.0F);
