 ...
 public class EntityIfrit extends EntityMob implements IBossDisplayData, IRangedAttackMob {
   ...
   public int getBrightnessForRender(float p_70070_1_)
     ...
     public float getBrightness(float p_70013_1_) {
       return 1.0F; } public float getEyeHeight() { return this.height * 0.8F; } protected String getHurtSound() { return "fandomcraft:bossHurt"; } public EntityIfrit(World world) { super(world);
