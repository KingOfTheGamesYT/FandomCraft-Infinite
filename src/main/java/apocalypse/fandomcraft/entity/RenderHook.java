 ...
 public class RenderHook
   extends Render
 {
   private static final ResourceLocation arrowTextures = new ResourceLocation("fandomcraft:textures/items/hook.png");

   public void doRender(StraightHook p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_) {
