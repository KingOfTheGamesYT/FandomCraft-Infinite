 ...
 public class EntityMiniblin extends EntityMob {
   protected void fall(float p_70069_1_) {}

   public EntityMiniblin(World world) {
     super(world);
     setSize(1.0F, 1.5F);
     getNavigator().setAvoidsWater(true);
     this.tasks.addTask(0, (EntityAIBase)new EntityAIWander((EntityCreature)this, 0.3D));
     this.tasks.addTask(5, (EntityAIBase)new EntityAILeapAtTarget((EntityLiving)this, 1.0F));
   ...
   protected String getLivingSound() {
     return "fandomcraft:Poke";
   }

   protected String getHurtSound() {
     return "fandomcraft:miniblinAttack";
   }
   ...
   public boolean attackEntityAsMob(Entity p_70652_1_) {
     ...
     playSound("fandomcraft:miniblinAttack", 1.0F, 1.0F / (getRNG().nextFloat() * 0.4F + 0.8F));
     return flag;
   }
