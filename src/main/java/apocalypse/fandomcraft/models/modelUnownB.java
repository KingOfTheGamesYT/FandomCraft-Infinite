   ...
   extends ModelBase
 {
   ...
   public modelUnownB() {
     ...
     this.Shape12.setRotationPoint(1.5F, -2.4F, 0.0F);
     ...
     this.Shape11.setRotationPoint(-3.0F, -4.0F, 0.0F);
     ...
     this.Shape9.setRotationPoint(-3.0F, -4.0F, 0.0F);
     this.Shape9.setTextureSize(32, 32);
     this.Shape9.mirror = true;
     setRotation(this.Shape9, 0.0F, 0.0F, 0.0F);
     this.Shape10 = new ModelRenderer(this, 0, 0);
     this.Shape10.addBox(0.0F, -3.0F, 0.0F, 1, 2, 1);
     this.Shape10.setRotationPoint(2.4F, -1.0F, 0.0F);
     this.Shape10.setTextureSize(32, 32);
     this.Shape10.mirror = true;
     setRotation(this.Shape10, 0.0F, 0.0F, -0.8028515F);
     this.Shape13 = new ModelRenderer(this, 0, 0);
     this.Shape13.addBox(-1.0F, -2.0F, 0.0F, 1, 3, 1);
     this.Shape13.setRotationPoint(1.0F, 0.0F, 0.0F);
     this.Shape13.setTextureSize(32, 32);
     this.Shape13.mirror = true;
     setRotation(this.Shape13, 0.0F, 0.0F, 0.8028515F);
   }
