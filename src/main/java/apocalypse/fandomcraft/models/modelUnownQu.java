   ...
   extends ModelBase
 {
   ...
   public modelUnownQu() {
     ...
     this.Shape9.addBox(-0.5F, -3.0F, 0.0F, 1, 3, 1);
     this.Shape9.setRotationPoint(0.0F, 0.0F, 0.0F);
     this.Shape9.setTextureSize(32, 32);
     this.Shape9.mirror = true;
     setRotation(this.Shape9, 0.0F, 0.0F, 0.0F);
     this.Shape10 = new ModelRenderer(this, 0, 0);
     this.Shape10.addBox(-2.0F, 0.0F, 0.0F, 4, 2, 2);
     this.Shape10.setRotationPoint(0.0F, 1.0F, -0.5F);
     ...
     this.Shape12.setRotationPoint(2.5F, -8.5F, 0.0F);
     ...
     this.Shape13.setRotationPoint(0.0F, -10.0F, 0.0F);
     this.Shape13.setTextureSize(32, 32);
     this.Shape13.mirror = true;
     setRotation(this.Shape13, 0.0F, 0.0F, 0.4363323F);
     this.Shape14 = new ModelRenderer(this, 0, 0);
     this.Shape14.addBox(0.0F, 0.0F, 0.0F, 3, 1, 1);
     this.Shape14.setRotationPoint(-3.0F, -8.5F, 0.0F);
     this.Shape14.setTextureSize(32, 32);
     this.Shape14.mirror = true;
     setRotation(this.Shape14, 0.0F, 0.0F, -0.4363323F);
   }
