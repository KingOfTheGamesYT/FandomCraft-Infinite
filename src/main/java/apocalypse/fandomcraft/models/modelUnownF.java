   ...
   extends ModelBase
 {
   ...
   public modelUnownF() {
     ...
     this.Shape10.setRotationPoint(3.0F, 2.0F, 0.0F);
     ...
     this.Shape12.setRotationPoint(-0.5F, 5.5F, 0.0F);
     ...
     this.Shape13.setRotationPoint(0.0F, 7.0F, 0.0F);
     this.Shape13.setTextureSize(32, 32);
     this.Shape13.mirror = true;
     setRotation(this.Shape13, 0.0F, 0.0F, 0.0F);
     this.Shape14 = new ModelRenderer(this, 0, 0);
     this.Shape14.addBox(-2.0F, 0.0F, 0.0F, 4, 1, 1);
     this.Shape14.setRotationPoint(0.0F, 9.0F, 0.0F);
