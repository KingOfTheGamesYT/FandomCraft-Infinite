   ...
   extends ModelBase
 {
   ...
   public modelUnownG() {
     ...
     this.Shape9.setRotationPoint(-1.0F, 8.0F, 0.0F);
     this.Shape9.setTextureSize(32, 32);
     this.Shape9.mirror = true;
     setRotation(this.Shape9, 0.0F, 0.0F, 2.356194F);
     this.Shape11 = new ModelRenderer(this, 0, 0);
     this.Shape11.addBox(-1.0F, -4.0F, 0.0F, 1, 4, 1);
     this.Shape11.setRotationPoint(-1.0F, 9.0F, 0.0F);
     ...
     this.Shape10.setRotationPoint(2.0F, -3.0F, 0.0F);
     this.Shape10.setTextureSize(32, 32);
     this.Shape10.mirror = true;
     setRotation(this.Shape10, 0.0F, 0.0F, 0.0F);
     this.Shape12 = new ModelRenderer(this, 20, 28);
     this.Shape12.addBox(0.0F, 0.0F, 0.0F, 5, 3, 1);
     this.Shape12.setRotationPoint(-2.5F, -2.5F, 0.0F);
