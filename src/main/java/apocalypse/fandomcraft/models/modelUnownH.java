   ...
   extends ModelBase
 {
   ...
   public modelUnownH() {
     ...
     this.Shape9.setRotationPoint(-7.0F, 3.0F, 0.0F);
     this.Shape9.setTextureSize(32, 32);
     this.Shape9.mirror = true;
     setRotation(this.Shape9, 0.0F, 0.0F, 2.356194F);
     this.Shape11 = new ModelRenderer(this, 0, 0);
     this.Shape11.addBox(-1.0F, -9.0F, 0.0F, 1, 9, 1);
     this.Shape11.setRotationPoint(1.0F, 10.0F, 0.0F);
     this.Shape11.setTextureSize(32, 32);
     this.Shape11.mirror = true;
     setRotation(this.Shape11, 0.0F, 0.0F, 0.7853982F);
     this.Shape10 = new ModelRenderer(this, 0, 0);
     this.Shape10.addBox(-1.0F, -9.0F, 0.0F, 1, 9, 1);
     this.Shape10.setRotationPoint(-7.0F, 3.0F, 0.0F);
     this.Shape10.setTextureSize(32, 32);
     this.Shape10.mirror = true;
     setRotation(this.Shape10, 0.0F, 0.0F, 0.7853982F);
     this.Shape12 = new ModelRenderer(this, 0, 0);
     this.Shape12.addBox(0.0F, -9.0F, 0.0F, 1, 9, 1);
     this.Shape12.setRotationPoint(1.0F, -4.0F, 0.0F);
     this.Shape12.setTextureSize(32, 32);
     this.Shape12.mirror = true;
     setRotation(this.Shape12, 0.0F, 0.0F, 2.356194F);
     this.Shape13 = new ModelRenderer(this, 0, 0);
     this.Shape13.addBox(0.0F, -0.5F, 0.0F, 5, 1, 1);
     this.Shape13.setRotationPoint(-7.8F, 3.0F, 0.0F);
     this.Shape13.setTextureSize(32, 32);
     this.Shape13.mirror = true;
     setRotation(this.Shape13, 0.0F, 0.0F, 0.0F);
     this.Shape14 = new ModelRenderer(this, 0, 0);
     this.Shape14.addBox(0.0F, -0.5F, 0.0F, 5, 1, 1);
     this.Shape14.setRotationPoint(2.5F, 3.0F, 0.0F);
