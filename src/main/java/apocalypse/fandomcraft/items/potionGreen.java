...
public class potionGreen extends ItemFood
{
    private int[] potionEffect;
    private int[] potionTier;
    
    public potionGreen(final int hunger, final float saturation, final boolean wolfFood) {
    ...
    public void addInformation(final ItemStack item, final EntityPlayer player, final List list, final boolean par4) {
        list.add("Restores 8 hearts and energy.");
    }
}
