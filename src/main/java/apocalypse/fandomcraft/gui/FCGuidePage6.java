...
public class FCGuidePage6 extends GuiContainer {
    ...
    public FCGuidePage6(World world, int i, int j, int k, EntityPlayer entity) {
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        int posX = this.width / 2;
        int posY = this.height / 2;
        this.fontRendererObj.drawString("The Keybearer", posX + -34, posY + -60, 16777215);
        this.fontRendererObj.drawString("--------------------------------------", posX + -115, posY + -52, 16777215);
        this.fontRendererObj.drawString("To obtain the Keyblade:", posX + -149, posY + -21, 16777215);
        this.fontRendererObj.drawString("Find a Dream Sword and use it to kill 64 evil mobs.", posX + -149, posY + -11, 12970214);
        this.fontRendererObj.drawString("Exchange it with Dark Hearts for the first Keyblade,", posX + -149, posY + 0, 12970214);
        this.fontRendererObj.drawString("the Kingdom Key, which can be upgraded many times.", posX + -149, posY + 11, 12970214);
        this.fontRendererObj.drawString("Main goal:", posX + -149, posY + 29, 16777215);
        this.fontRendererObj.drawString("Upgrade the Keyblade many times, all the way to Ultima.", posX + -149, posY + 38, 12970214);
        this.fontRendererObj.drawString("More will be added in the Kingdom Hearts update.", posX + -149, posY + 48, 12970214);
        this.fontRendererObj.drawString("*Kingdom Hearts*", posX + -140, posY + -113, 16777215);
        ...
        this.mc.renderEngine.bindTexture(new ResourceLocation("fandomcraft:textures/gui/stretchedIcons/KH.png"));
