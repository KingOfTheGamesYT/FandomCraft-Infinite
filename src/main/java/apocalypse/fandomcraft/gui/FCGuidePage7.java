...
public class FCGuidePage7 extends GuiContainer {
    ...
    public FCGuidePage7(World world, int i, int j, int k, EntityPlayer entity) {
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        int posX = this.width / 2;
        int posY = this.height / 2;
        this.fontRendererObj.drawString("J.E.N.O.V.A.", posX + -34, posY + -60, 16777215);
        this.fontRendererObj.drawString("--------------------------------------", posX + -115, posY + -52, 16777215);
        this.fontRendererObj.drawString("To obtain Ragnarok:", posX + -149, posY + -21, 16777215);
        this.fontRendererObj.drawString("Kill thousands of mobs until you have enough Rupees to", posX + -149, posY + -11, 12970214);
        this.fontRendererObj.drawString("buy the Flametounge, Icebrand and Kikuichimonji, which", posX + -149, posY + 0, 12970214);
        this.fontRendererObj.drawString("create Ragnarok when forged together.", posX + -149, posY + 11, 12970214);
        this.fontRendererObj.drawString("Main goal:", posX + -149, posY + 29, 16777215);
        this.fontRendererObj.drawString("Will be in the Final Fantasy update.", posX + -149, posY + 38, 12970214);
        this.fontRendererObj.drawString("Currently the only boss implemented is Ifrit, who", posX + -149, posY + 48, 12970214);
        this.fontRendererObj.drawString("can be summoned with Magicite found in chests.", posX + -149, posY + 58, 12970214);
        this.fontRendererObj.drawString("*Final Fantasy*", posX + -140, posY + -113, 16777215);
        ...
        this.mc.renderEngine.bindTexture(new ResourceLocation("fandomcraft:textures/gui/stretchedIcons/FF.png"));
