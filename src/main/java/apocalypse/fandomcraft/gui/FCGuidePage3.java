...
public class FCGuidePage3 extends GuiContainer {
    ...
    public FCGuidePage3(World world, int i, int j, int k, EntityPlayer entity) {
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        int posX = this.width / 2;
        int posY = this.height / 2;
        this.fontRendererObj.drawString("Hogwarts", posX + -34, posY + -60, 16777215);
        this.fontRendererObj.drawString("--------------------------------------", posX + -115, posY + -52, 16777215);
        this.fontRendererObj.drawString("Will be added in the Harry Potter update.", posX + -149, posY + -21, 16777215);
        this.fontRendererObj.drawString("*Harry Potter*", posX + -140, posY + -113, 16777215);
        ...
        this.mc.renderEngine.bindTexture(new ResourceLocation("fandomcraft:textures/gui/stretchedIcons/HP.png"));
