...
public class FCGuidePage4 extends GuiContainer {
    ...
    public FCGuidePage4(World world, int i, int j, int k, EntityPlayer entity) {
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        int posX = this.width / 2;
        int posY = this.height / 2;
        this.fontRendererObj.drawString("Rings of Chaos", posX + -34, posY + -60, 16777215);
        this.fontRendererObj.drawString("--------------------------------------", posX + -115, posY + -52, 16777215);
        this.fontRendererObj.drawString("Defeat Chaos:", posX + -149, posY + -21, 16777215);
        this.fontRendererObj.drawString("Find all 6 Chaos Emeralds in various dungeons.", posX + -149, posY + -11, 12970214);
        this.fontRendererObj.drawString("Combine all 6 with Rings to create the Master Emerald", posX + -149, posY + 0, 12970214);
        this.fontRendererObj.drawString("Use the Master Emerald to spawn Chaos.", posX + -149, posY + 11, 12970214);
        this.fontRendererObj.drawString("Other:", posX + -149, posY + 29, 16777215);
        this.fontRendererObj.drawString("More quests will be added in the Classics udpate.", posX + -149, posY + 38, 12970214);
        this.fontRendererObj.drawString("*Sonic The Hedgehog*", posX + -140, posY + -113, 16777215);
        ...
        this.mc.renderEngine.bindTexture(new ResourceLocation("fandomcraft:textures/gui/stretchedIcons/sonic.png"));
