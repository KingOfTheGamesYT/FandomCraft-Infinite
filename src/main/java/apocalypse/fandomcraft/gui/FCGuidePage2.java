...
public class FCGuidePage2 extends GuiContainer {
    ...
    public FCGuidePage2(World world, int i, int j, int k, EntityPlayer entity) {
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        int posX = this.width / 2;
        int posY = this.height / 2;
        this.fontRendererObj.drawString("Gates of Hell", posX + -34, posY + -60, 16777215);
        ...
        this.fontRendererObj.drawString("*The Elder Scrolls*", posX + -140, posY + -113, 16777215);
        ...
        this.mc.renderEngine.bindTexture(new ResourceLocation("fandomcraft:textures/gui/stretchedIcons/Elder.png"));
