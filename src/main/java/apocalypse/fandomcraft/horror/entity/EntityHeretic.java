...
public class EntityHeretic extends EntityMob {
    protected void fall(float p_70069_1_) {
    }

    public EntityHeretic(World world) {
        super(world);
        ...
        this.targetTasks.addTask(2, new EntityAINearestAttackableTarget(this, EntityHeretic.class, 0, true));
    ...
    protected void addRandomArmor() {
        ...
        this.setCurrentItemOrArmor(0, new ItemStack(Main.mace));
    }
}
