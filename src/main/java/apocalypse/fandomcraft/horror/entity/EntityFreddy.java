...
public class EntityFreddy extends EntityMob implements IBossDisplayData {
    ...
    protected void dropRareDrop(int p_70600_1_) {
        switch(this.rand.nextInt(3)) {
            case 0:
                ...
                break;
            case 1:
                this.dropItem(HorrorReg.backpack, 1);
                break;
            case 2:
    ...
    protected void addRandomArmor() {
        ...
        this.setCurrentItemOrArmor(0, new ItemStack(HorrorReg.bladedGlove));
    }
}
