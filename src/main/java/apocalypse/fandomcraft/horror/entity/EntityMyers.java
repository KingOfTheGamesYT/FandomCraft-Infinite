...
public class EntityMyers extends EntityMob implements IBossDisplayData {
    ...
    public EntityMyers(World world) {
        super(world);
    ...
    protected void dropRareDrop(int p_70600_1_) {
        switch(this.rand.nextInt(3)) {
            case 0:
                ...
                break;
            case 1:
                this.dropItem(HorrorReg.maskMyers, 1);
                break;
            case 2:
                this.dropItem(HorrorReg.record_halloween, 1);
        }
    ...
    protected void addRandomArmor() {
        ...
        this.setCurrentItemOrArmor(0, new ItemStack(HorrorReg.machette));
    }

    static {
        defaultHeldItem = new ItemStack(Main.masterSword);
    }
}
