...
public class EntityMerchantOver extends EntityCreature implements INpc {
    private EntityPlayer buyingPlayer;

    public EntityMerchantOver(World world) {
        super(world);
    }

    public EntityMerchantOver(World p_i1748_1_, int p_i1748_2_) {
        super(p_i1748_1_);
    ...
    public boolean interact(EntityPlayer p_70085_1_) {
        if (this.isEntityAlive() && !p_70085_1_.isSneaking()) {
            if (!this.worldObj.isRemote) {
                ...
                p_70085_1_.openGui(Main.instance, Main.GuiTravellerOver, p_70085_1_.worldObj, i, j, k);
                Tools.println("Opening GUI with id of " + Main.GuiTravellerOver);
            }
