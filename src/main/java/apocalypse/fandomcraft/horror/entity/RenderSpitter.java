 ...
 import apocalypse.fandomcraft.entity.EntitySpitter;
 ...
 public class RenderSpitter extends RenderBiped
 {
   private float scale;
   private static final ResourceLocation textures = new ResourceLocation("fandomcraft:textures/models/entity/spitter.png");

   public ModelSpitter modelSpitter;

   public RenderSpitter(ModelSpitter base, float f, float s) {
     super(base, f * s);
     this.scale = s;
   }
   ...
   protected void preRenderCallback(EntitySpitter p_77041_1_, float p_77041_2_) {
     GL11.glScalef(this.scale, this.scale, this.scale);
   }

   protected void preRenderCallback(EntityLivingBase p_77041_1_, float p_77041_2_) {
     preRenderCallback((EntitySpitter) p_77041_1_, p_77041_2_);
   }
   ...
   protected void renderEquippedItems(EntityLiving p_77029_1_, float p_77029_2_) {
     ...
     if (itemstack1 != null) {
       ...
       GL11.glPushMatrix();
       this.modelSpitter.bipedHead.postRender(0.0625F);
