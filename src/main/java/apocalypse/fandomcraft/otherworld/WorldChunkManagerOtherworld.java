...
public class WorldChunkManagerOtherworld extends WorldChunkManager
{
    ...
    public WorldChunkManagerOtherworld() {
        this.biomeCache = new BiomeCache((WorldChunkManager)this);
        (this.biomesToSpawnIn = new ArrayList<BiomeGenBase>()).add(FCBiomes.badlands);
        this.biomesToSpawnIn.add(FCBiomes.bloodwood);
    }
    
    public WorldChunkManagerOtherworld(final long seed, final WorldType worldType) {
        this();
        GenLayer[] agenlayer = OtherworldGenLayer.makeTheWorld(seed, worldType);
        agenlayer = this.getModdedBiomeGenerators(worldType, seed, agenlayer);
        this.genBiomes = agenlayer[0];
        this.biomeIndexLayer = agenlayer[1];
    }
    
    public WorldChunkManagerOtherworld(final World world) {
