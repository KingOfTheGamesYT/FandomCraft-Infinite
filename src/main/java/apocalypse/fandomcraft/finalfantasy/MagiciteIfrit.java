 package apocalypse.fandomcraft.finalfantasy;
   ...
   extends Item
 {
   ...
   public boolean hasEffect(ItemStack itemstack) {
     return true;
       ...
       public void addInformation(ItemStack item, List<String> list, boolean par4) {
     list.add("Summons Ifrit.");
   }
   ...
   public boolean onItemUse(ItemStack p_77648_1_, EntityPlayer p_77648_2_, World p_77648_3_, int p_77648_4_, int p_77648_5_, int p_77648_6_, int p_77648_7_, float p_77648_8_, float p_77648_9_, float p_77648_10_) {
     ...
     Entity entity = spawnCreature(p_77648_3_, p_77648_1_.getItemSpriteNumber(), p_77648_4_ + 0.5D, p_77648_5_ + d0, p_77648_6_ + 0.5D);
   ...
   public ItemStack onItemRightClick(ItemStack p_77659_1_, World p_77659_2_, EntityPlayer p_77659_3_) {
     ...
     if (movingobjectposition.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
       ...
       if (p_77659_2_.getBlock(i, j, k) instanceof net.minecraft.block.BlockLiquid) {
         ...
         Entity entity = spawnCreature(p_77659_2_, p_77659_1_.getItemSpriteNumber(), i, j, k);
   ...
   public static Entity spawnCreature(World world, int p_77840_1_, double x, double y, double z) {
     EntityIfrit chaos = new EntityIfrit(world);
