 ...
 public class RenderBullet
   extends Render
 {
   private static final ResourceLocation arrowTextures = new ResourceLocation("fandomcraft:textures/items/bullet.png");

   private static final String __OBFID = "CL_00000978";

   public void doRender(ProjectileBullet p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_) {
   ...
   protected ResourceLocation getEntityTexture(Entity p_110775_1_) {
     return getEntityTexture((ProjectileBullet)p_110775_1_);
   }

   public void doRender(Entity p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_) {
     doRender((ProjectileBullet)p_76986_1_, p_76986_2_, p_76986_4_, p_76986_6_, p_76986_8_, p_76986_9_);
   }
 }