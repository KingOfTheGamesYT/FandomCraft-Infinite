...
public class AppraisingOre extends Item {
    ...
    public ActionResult<ItemStack> onItemRightClick(World par2World, PlayerEntity par3EntityPlayer, Hand hand) {
        ...
        if (!par2World.isRemote) {
            ...
            int basickit = par3EntityPlayer.inventory.findSlotMatchingUnusedItem(new ItemStack(RegistryHandler.APPRAISAL_KIT_BASIC.get()));
            int advancedkit = par3EntityPlayer.inventory.findSlotMatchingUnusedItem(new ItemStack(RegistryHandler.APPRAISAL_KIT_ADVANCED.get()));
            int masterkit = par3EntityPlayer.inventory.findSlotMatchingUnusedItem(new ItemStack(RegistryHandler.APPRAISAL_KIT_MASTER.get()));
            ...
            if (par3EntityPlayer.inventory.hasItemStack(new ItemStack(RegistryHandler.APPRAISAL_KIT_BASIC.get()))) {
                    ...
                    // Remove one appraisal kit from the inventory
                    ItemStack kitStack = par3EntityPlayer.inventory.getStackInSlot(basickit);
                    kitStack.shrink(1);
                    if (kitStack.isEmpty()) {
                        par3EntityPlayer.inventory.removeStackFromSlot(basickit);
                    }
                ...
                ItemStack kitStack = par3EntityPlayer.inventory.getStackInSlot(advancedkit);
                kitStack.shrink(1);
                if (kitStack.isEmpty()) {
                    par3EntityPlayer.inventory.removeStackFromSlot(advancedkit);
                }
                ...
                ItemStack kitStack = par3EntityPlayer.inventory.getStackInSlot(masterkit);
                kitStack.shrink(1);
                if (kitStack.isEmpty()) {
                    par3EntityPlayer.inventory.removeStackFromSlot(masterkit);
                }
