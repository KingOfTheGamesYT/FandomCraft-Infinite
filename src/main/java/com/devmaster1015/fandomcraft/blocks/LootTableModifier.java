...
public class LootTableModifier {
        ...
        static {
            ...
            DROPS.add(new WeightedDrop(RegistryHandler.BLUE_BERRY, 5));
            DROPS.add(new WeightedDrop(RegistryHandler.WORM, 5));
            ...
            DROPS.add(new WeightedDrop(RegistryHandler.GARLIC, 1));
            DROPS.add(new WeightedDrop(RegistryHandler.HEART, 1));
